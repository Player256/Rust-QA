...
def parse_arge():
    ...
    parser.add_argument("--sm_train_dataset_path", type=str, default="lm_dataset", help="Path to dataset.")
    parser.add_argument("--sm_test_dataset_path", type=str, default="lm_dataset", help="Path to dataset.")
